    ...
    return (
        ...
        <section className="max-w-[1440px] mx-auto p-8 mt-10 lg:mt-[100px]">
            <div className="flex flex-col justify-center items-center gap-4 w-full">
                <h1 className="text-black font-semibold text-[50px] lg:text-[60px] text-center">{contactData.title}</h1>
                <p className="text-[#5A5A5A] text-base lg:text-xl text-center">{contactData.description}</p>
