                    ...
                    <div className="flex flex-col justify-center items-center lg:items-start">
                        ...
                        <div className="flex flex-col justify-center items-center lg:items-start gap-4 mt-4">
                            ...
                            <div className="flex justify-center lg:justify-start gap-2">
                                ...
                                <Link href={heroData.hrefProject} className="bg-white">
                                    <button className="bg-white cursor-pointer text-black text-base lg:text-xl transition-all duration-700 hover:-translate-y-2 py-2 px-[28px]">
                                        {heroData.btnProject}
                                    </button>
                                </Link>
                            </div>
