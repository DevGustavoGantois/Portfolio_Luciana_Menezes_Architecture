...
export function Footer() {
  return (
    <footer className="relative bg-black w-full mt-10 lg:mt-[100px]">
      {footerData.map((item, index) => (
        ...
        >
          ...
          <p className="relative text-white text-base lg:text-xl tracking-wide text-center max-w-6xl mb-8">
            {item.copyright}
          </p>
        </div>
      ))}
